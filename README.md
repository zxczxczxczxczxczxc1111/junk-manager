...
- Показывает, какие папки и файлы занимают место на диске, и сохраняет отчёт в CSV.
...
В разделе «Место на диске» можно посмотреть размеры папок приложений и Windows, найти крупные файлы и открыть их расположение. Сам подсчёт ничего не удаляет.
